...
<div class="products-grid">
    <div class="product-item"
        data-full-description="Tas Gucci original second-hand dengan kondisi sangat baik. Hanya dipakai dua kali untuk acara formal. Kulit asli, lengkap dengan dust bag."
        data-rating="4.5"
        data-category="Aksesoris Fashion"
        data-condition="Sangat Baik">
        <div class="product-image">
    ...
    <div class="product-item"
        data-full-description="Jam tangan Casio dengan desain vintage yang otentik. Mesin masih berjalan akurat dan sangat terawat. Tali stainless steel original."
        data-rating="4.0"
        data-category="Jam Tangan"
        data-condition="Baik">
        <div class="product-image">
    ...
    <div class="product-item"
        data-full-description="Sepatu Converse edisi terbatas, ukuran 42. Kondisi sol masih 95% dan warna belum pudar. Cocok untuk koleksi atau dipakai sehari-hari."
        data-rating="5.0"
        data-category="Sepatu"
        data-condition="Seperti Baru">
        <div class="product-image">
